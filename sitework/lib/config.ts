...
{id:"TFpT0wCHnmM",title:"AI can suggest. The business decides.",description:"A simple look at the difference between AI suggesting an action and the business giving permission for that action.",orientation:"vertical" as const},
