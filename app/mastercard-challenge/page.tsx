    ...
    <main>
      <section className="bg-paper border-b border-divider">
        <div className="max-w-container mx-auto px-6 py-16 md:py-20 lg:py-24">
          <p className="text-sm font-mono uppercase tracking-wide text-mint-deep">
            Mastercard Innovation Challenge @ GFF 2026, Parmana Submission
          </p>
          <h1 className="mt-4 font-serif text-[30px] md:text-[40px] font-semibold leading-[1.2] tracking-tight text-navy max-w-[760px]">
            Authorization infrastructure for agentic commerce.
          </h1>
          <p className="mt-5 text-lg leading-[1.6] text-navy/70 max-w-[640px]">
      ...
      <section className="bg-paper border-b border-divider">
        <div className="max-w-container mx-auto px-6 py-16 md:py-20 lg:py-24">
          <h2 className="font-serif text-[24px] md:text-[28px] font-semibold text-navy text-center">
            How it works
          </h2>
          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-6">
            {pillars.map((pillar) => (
              ...
              >
                ...
                <p className="text-sm leading-[1.65] text-navy/70">{pillar.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-paper border-b border-divider">
        <div className="max-w-container mx-auto px-6 py-16 md:py-20 lg:py-24 max-w-[820px]">
          <h2 className="font-serif text-[24px] md:text-[28px] font-semibold text-navy">
            For judges
          </h2>
          <p className="mt-5 text-base leading-[1.7] text-navy/70">
          ...
          <p className="mt-4 text-base leading-[1.7] text-navy/70">
          ...
          <a
            ...
            className="group mt-6 inline-flex items-center gap-1 text-sm font-semibold text-mint-deep hover:text-navy transition-colors duration-200"
          >
      ...
      <section className="bg-paper">
        <div className="max-w-container mx-auto px-6 py-16 md:py-20 lg:py-24 text-center">
          <h2 className="font-serif text-[24px] md:text-[28px] font-semibold text-navy max-w-[680px] mx-auto">
          ...
          <a
            ...
            className="mt-8 inline-flex items-center justify-center rounded-md bg-mint px-8 py-3 text-base font-semibold text-navy shadow-sm hover:bg-navy hover:text-paper hover:shadow-lg hover:shadow-mint/25 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 min-h-[48px]"
          >
            Contact the team
          </a>
        </div>
