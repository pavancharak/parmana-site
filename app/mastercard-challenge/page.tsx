    ...
    <main>
      <section className="bg-navy border-b border-divider">
        <div className="max-w-container mx-auto px-6 py-16 md:py-20 lg:py-24">
          ...
          <p className="mt-5 text-lg leading-[1.6] text-paper/70 max-w-[640px]">
      ...
      <section className="bg-navy border-b border-divider">
        <div className="max-w-container mx-auto px-6 py-16 md:py-20 lg:py-24 max-w-[820px]">
          ...
          <p className="mt-5 text-base leading-[1.7] text-paper/70">
          ...
          <p className="mt-4 text-base leading-[1.7] text-paper/70">
      ...
      <section className="bg-navy">
        <div className="max-w-container mx-auto px-6 py-16 md:py-20 lg:py-24 text-center">
          ...
          <a
            ...
            className="mt-8 inline-flex items-center justify-center rounded-md bg-mint px-8 py-3 text-base font-semibold text-navy shadow-sm hover:bg-paper hover:shadow-lg hover:shadow-mint/25 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 min-h-[48px]"
          >
            Contact the team
          </a>
        </div>
