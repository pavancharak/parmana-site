const layers = [
  ...
  { question: "Can you sign in?", label: "Authentication" },
  { question: "What can you access?", label: "Access" },
  { question: "What permissions do you have?", label: "Credentials" },
  ...
  return (
    <section id="gap" className="bg-lavender border-b border-border">
      <div className="max-w-container mx-auto px-6 py-16 md:py-20 lg:py-24">
        ...
        <p className="mt-4 text-center text-base text-ink/70 max-w-[680px] mx-auto">There is another question to answer before an important action happens.</p>
        <div className="mt-10 max-w-[620px] mx-auto space-y-3">
          ...
          <div className="rounded-md border-2 border-dashed border-purple bg-white px-6 py-6 text-center">
            ...
            <p className="mt-2 text-lg md:text-xl font-semibold text-ink">Is this action allowed by the business right now?</p>
          </div>
        </div>
      </div>
    </section>
