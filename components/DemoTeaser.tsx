      ...
      <div className="max-w-container mx-auto px-6 py-10 md:py-12">
        <div className="rounded-md border border-purple/30 bg-lavender px-6 py-8 md:px-10 md:py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            ...
            <h2 className="mt-2 text-lg md:text-xl font-bold text-ink">Watch an AI agent request a refund without owning the authority to execute it.</h2>
            <p className="mt-2 text-sm leading-[1.6] text-ink/70 max-w-[560px]">See the request, deterministic policy decision, payload-bound authorization and tamper rejection.</p>
          </div>
